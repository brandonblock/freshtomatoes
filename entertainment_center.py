...
# Create six movie objects, passing the strings title, description, poster image, and trailer link.
...
movie_b = media.Movie("Assault on Precinct 13",
                      "A police officer and a convicted murderer are forced to cooperate when local gangs attack.",
...
movie_c = media.Movie("In the Mouth of Madness",
                      "An author uncovers a mystery and discovers his own madness",
